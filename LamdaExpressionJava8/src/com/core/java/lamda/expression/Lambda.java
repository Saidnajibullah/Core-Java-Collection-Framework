package com.core.java.lamda.expression;
...
public class Lambda {
	...
	public static void main(String[] args) {
		...
		System.out.println("Labda Expression equivalent of the above code\n");
		//Labda Expression equivalent of the above code
		person.introduce(()-> System.out.println("Hello, I'm a person\n"));
	}
